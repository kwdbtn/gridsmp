...
class FetchSMPData extends Command {
    ...
    public function handle() {
        ...
        $systemData = DB::connection('smp_conn')->select('select * from id_descr where groupname = "1. System Data" or groupname = "2. Plant Generation" or groupname = "4. Voltages" or groupname = "9. Station Loads"');
